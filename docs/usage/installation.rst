...
.. tab-set::
    ...
    .. tab-item:: macOS (Intel Mac)
        ...
        .. code:: console
           ...
           curl -L https://github.com/attakei/age-cli/releases/download/v0.7.0/age-v0.7.0_macos_x86-64.zip | bsdtar x -
    ...
    .. tab-item:: Linux
        ...
        .. code:: console
           ...
           curl -L https://github.com/attakei/age-cli/releases/download/v0.7.0/age-v0.7.0_linux_x86-64.zip | bsdtar x -
           chmod +x age-v0.7.0/age
           cp age-v0.7.0/age /path/to/bin/
