...
.. tab-set::
    ...
    .. tab-item:: macOS (Intel Mac)
        ...
        .. code:: console
           ...
           curl -L https://github.com/attakei/age/releases/download/v0.10.0/age-v0.10.0_macos_arm64.zip | bsdtar x -
    ...
    .. tab-item:: Linux
        ...
        .. code:: console
           ...
           curl -L https://github.com/attakei/age/releases/download/v0.10.0/age-v0.10.0_linux_x86-64.zip | bsdtar x -
           chmod +x age-v0.10.0/age
           cp age-v0.10.0/age /path/to/bin/
